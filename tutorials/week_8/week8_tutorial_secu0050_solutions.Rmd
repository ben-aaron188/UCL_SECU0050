...
For this task, we will use a larger version of the YouTube corpus. Access the corpus from [https://github.com/ben-aaron188/UCL_SECU0050/blob/master/data/vlogs_corpus_10k.RData](https://github.com/ben-aaron188/UCL_SECU0050/blob/master/data/vlogs_corpus_10k.RData) and load the .RData file called `youtube_corpus_10k.RData` which contains 10,000 raw transripts of YouTube vlogs.

```{r}
# load the data
load('/Users/bennettkleinberg/GitHub/UCL_SECU0050/data/vlogs_corpus_10k.RData')
```
