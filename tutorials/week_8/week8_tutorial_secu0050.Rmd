...
For this task, we will use a larger version of the YouTube corpus. Access the corpus from [...]() and load the .RData file called `youtube_corpus_10k.RData` which contains 10,000 raw transripts of YouTube vlogs.
