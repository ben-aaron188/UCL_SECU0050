...
<img data-src="../img/arxiv1.png">

## Utilising the `aRxiv` package

- Docs: [https://ropensci.org/tutorials/arxiv_tutorial/](https://ropensci.org/tutorials/arxiv_tutorial/)
- Repo: [https://github.com/ropensci/aRxiv](https://github.com/ropensci/aRxiv)
...
```{r}
library(aRxiv)
arxiv_author_search = arxiv_search(query = 'au:"Hinrich Schuetze"', limit=50)
```

##

```{r}
knitr::kable(arxiv_author_search[1:5, c(1:4)])
```
...
All articles in the "Computation & Language" subcategory submitted in the 1st of May 2019.
