...
- closely related to Bayesian inference
...
## Problem in Bayes terms

$P(spam|text) = \frac{P(text|spam)*P(spam)}{P(text)}$

What we know:

- $P(spam) = \frac{2}{4} = 0.5$ (prior of outcome)
- $P(text)$ is a constant (prior of data)

## Needed: likelihood

$P(text|spam) = P(word_1|spam) * P(word_2|spam) ... P(word_n|spam)$

- $P('cash'|spam) = \frac{'cash'_{spam}}{'cash'_{total}} =  \frac{2}{3} = 0.67$


## What is $P('gmail'|spam)$
...
<img src='../img/naivebayesalbon.png'>

<small>Source: [chrisalbon.com](https://chrisalbon.com/#machine_learning)</small>
