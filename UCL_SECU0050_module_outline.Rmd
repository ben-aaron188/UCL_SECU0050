...
- TA: Daniel Hammocks, Doctoral researcher, daniel.hammocks@ucl.ac.uk
...
| 30       	| 10          	| 19 Mar 	| Case studies I          	|
| 31       	| 11          	| 26 Mar 	| Case studies II          	|
| 32       	| 12          	| 30 Mar 	| **Class test**           	|
...
- Required preparation
    ...
    - _tuber_ - Access YouTube API via R. [https://soodoku.github.io/tuber/](https://soodoku.github.io/tuber/)
    - Jeong, J. (2019). What Is API and How To Use Youtube API? [https://towardsdatascience.com/what-is-api-and-how-to-use-youtube-api-65525744f520](https://towardsdatascience.com/what-is-api-and-how-to-use-youtube-api-65525744f520)
    - YouTube. [Obtaining authorization credentials](https://developers.google.com/youtube/registering_an_application)
- Slides
- Tutorial
- Homework
...
- [An Introduction to Text Mining](http://us.sagepub.com/en-us/nam/an-introduction-to-text-mining/book249451#contents) (Ignatow & Mihalcea, 2018) - SAGE
    - _We aim to make this book available as digital copies through UCL library services_
    - You can buy the paper version at a UCL student discount via this link [https://studysites.uk.sagepub.com/dts-studentdeal/](https://studysites.uk.sagepub.com/dts-studentdeal/)
...
- Date: 30 March 2020, 10am-12pm, IOE 20 Bedford Way, Room 305 – Clarke Hall.
